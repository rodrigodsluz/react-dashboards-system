...
const ContestacaoMovimentacaoFraude = ({
  values,
  handleChange,
  formLoaded,
  loadingIncidents,
...
ContestacaoMovimentacaoFraude.defaultProps = {
...
ContestacaoMovimentacaoFraude.propTypes = {
  values: PropTypes.shape({
...
export default ContestacaoMovimentacaoFraude;
