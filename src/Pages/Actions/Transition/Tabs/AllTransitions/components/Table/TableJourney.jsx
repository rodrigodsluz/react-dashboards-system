...
const columns = [
  { id: 'JourneyName', label: 'Status', minWidth: 200 },
  { id: 'modality', label: 'Template', minWidth: 200 },
...
export default function TableJourney({ data, filtered, currentProductById }) {
  ...
  const handleFilterTableByUsername = useCallback(
    (e) => {
      e?.preventDefault();

      const results = filtered !== ''
        ? allRows.filter((v) => v.JourneyName.toLowerCase().match(filtered?.toLowerCase()))
        : allRows;
